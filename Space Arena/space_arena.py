...
wn = turtle.Screen()
wn.setup(SCEEEN_WIDTH + 220, SCEEEN_HEIGHT + 20)
wn.title("Space Arena by Shlomi")
wn.bgcolor("black")
wn.tracer(0)
...
class CharacterPen():
    def __init__(self, color = "white", scale = 1.0):
        ...
        self.characters = {}
        # here we draw each character using coordinate,
        # we drawing line using the coordinate that create the 
        # charactar without removing the pen up  
        ...
        self.characters["E"] = ((5,10),(-5,10),(-5,-10),(0,0),(-5,0),(-5,-10),(5,-10))
...
class Sprite():
    ...
    def __init__(self, x, y, shape, color):
        ...
        self.health = 100
        self.max_health = 100
        self.width = 20 #defult size in turtle
        self.height = 20 #defult size in turtle
        self.state = "active"
        self.radar = 200
        self.max_dx = 5
        self.max_dy = 5
...
class Player(Sprite):
    ...
    def __init__(self, x, y, shape, color):
        ...
        self.da = 0
        # fire mode
        fire_modes = ["one", "two" ,"three"]
        self.fire_mode = "three"
...
wn.onkeypress(player.slowmotion,"w")
